...
- [ ] **PHASE 4 — Parkour** — vault, mantle, ledge grab, climb, wall jump, ladders, controlled falls
- [ ] **PHASE 5 — Vertical slice environment** — Old Market zone: settlement, buildings with interiors, rooftops, underground section; Breakable component (wooden doors, weak walls); save/load v1
